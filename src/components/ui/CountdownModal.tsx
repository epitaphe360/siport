          ...
          <div className="p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg"
                onClick={() => {
                  alert(`📅 RAPPEL PROGRAMMÉ\n\n⏰ Notification 24h avant l'ouverture\n📱 Rappel mobile activé\n📧 Email de rappel configuré\n📍 Itinéraire vers El Jadida inclus\n\n✅ Vous ne manquerez pas SIPORTS 2026 !`);
                }}
              >
              ...
              <Button 
                ...
                onClick={() => {
                  ...
                  if (navigator.share) {
                    ...
                    alert('🔗 Compte à rebours copié dans le presse-papiers !');
                  }
                }}
              >
              ...
              <Button 
                ...
                onClick={() => {
                  ...
                  alert('📅 ÉVÉNEMENT AJOUTÉ\n\n✅ SIPORTS 2026 ajouté à votre calendrier\n📱 Rappels automatiques configurés\n📍 Lieu et itinéraire inclus\n\n🎯 Vous êtes prêt pour le salon !');
                }}
              >
